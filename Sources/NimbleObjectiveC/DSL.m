...
+ (void)untilTimeout:(NSTimeInterval)timeout file:(NSString *)file line:(NSUInteger)line action:(void (^)(void(^)(void)))action;
+ (void)untilFile:(NSString *)file line:(NSUInteger)line action:(void (^)(void(^)(void)))action;
